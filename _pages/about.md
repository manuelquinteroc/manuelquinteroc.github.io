...
My current research interests lie in developing and applying statistical methods for causal identification and using Machine Learning for causal inference, as well as applications of such techniques in the social sciences. In the past, I have worked with Time Series, Structural Models, Causal Inference, and Randomized Controlled Trials to understand and mitigate social problems.
